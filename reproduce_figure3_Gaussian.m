%REPRODUCE_FIGURE3_GAUSSIAN  Reproduce the TH panel of Fig. 3 (Gaussian).
%
...
%  the top three rows of Figure 3.  The original figure additionally
...
%
%  Setting (noise-free):
%     A1 in R^{64 x 1024},  Gaussian with r = 0.5
...
%     PNG saved to ./outputs/figure3_TH_Gaussian.png
...
pm.x0       = xL1;
pm.iter     = 5 * pm.N;
pm.DataRegP = 2e3;               % continuation: fidelity weight
...
% Save
outFile = fullfile(outputDir, 'figure3_TH_Gaussian.png');
